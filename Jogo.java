...
public class Jogo {
    ...
    public void moverPeca(int origemX, int origemY, int destinoX, int destinoY) {
        ...
        //Bloco de verificação se a peça é branca ou preta, assim como o jogador da vez também
        if((peca.getTipo() % 2 == 0) && (getjogadorDaVez() != 0)){
            return;
        }
    ...
    //Bloco de turno, realiza os movimentos de acordo com a vez de cada jogador
